...
for ((i=1850;i<2010;i=i+10))
   do 
     /iitm4/cccr/cmip6/Manmeet/anaconda3/envs/CMOR/bin/python    ./Amon_hist_3d.py ${i} $(($i+10))
   done
  /iitm4/cccr/cmip6/Manmeet/anaconda3/envs/CMOR/bin/python Amon_hist_3d.py 2010 2015
#yyyy=$yyyy 
