...
dformat3 = 'atm_3hr_inst_%Y_%m_%d_%H.nc'
...
vardf = pd.read_csv('A3hourly_2d_varlist_inst',skipinitialspace=True)
...
while ddate < enddate:
	...
	mdatec=sp.check_output(['./datefunc', 'incdate', 'julian '+ddatec+' 0,0,0,3,0,0'])
